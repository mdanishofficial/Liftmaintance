...
export class MenuPage implements OnInit {
  ...
  async malfunction() {
    ...
    this.router.navigateByUrl(
      'installation_manager/currentmalfunctionslist/' + refresh
    );
  }
  myclient() {
    var refresh = true;
  ...
  complain() {
    var refresh = true;
    this.router.navigateByUrl(
      'installation_manager/pendingcomplain/' + refresh
    );
  }
  emergencycomplain() {
    var refresh = true;
    this.router.navigateByUrl(
      'installation_manager/pendingemergencycomplain/' + refresh
    );
  }
  myteam() {
    var refresh = true;
    this.router.navigateByUrl(
      'installation_manager/repair_technicians/' + refresh
    );
  }
}
