...
export class InstallationService {
  ...
  public getoneinstallation(data): Observable<any> {
    const url = PCconfig.getPath() + '/installations/getoneinstallation';
    return this.http.post(url, data);
  }
                            ...
                            public getinquiries(data): Observable<any> {
                              ...
                              public addinquiry(data): Observable<any> {
                                ...
                                public getparts(data): Observable<any> {
                                  const url = PCconfig.getPath() + '/bills/getparts?status=notprovided';
                                  // return this.http.post(url, data);
                                  return this.http
                                  .post(url, data)
                                  .pipe(
                                  ...
                                  public getprovidedparts(data): Observable<any> {
                                    const url = PCconfig.getPath() + '/bills/getparts?status=provided';
                                    // return this.http.post(url, data);
                                    return this.http
                                    .post(url, data)
                                    .pipe(
                                    ...
                                    public getnotifications(data): Observable<any> {
                                      ...
                                      public getcontract(data): Observable<any> {
                                        ...
                                        public addmessage(data): Observable<any> {
                                          const url = PCconfig.getPath() + '/contactus/addmessage';
                                          // return this.http.post(url, data);
                                          return this.http
                                          .post(url, data)
                                          .pipe(
